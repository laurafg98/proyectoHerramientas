...
brca_rnaseq <- load("brca_rnaseq.RData")
...
#save(brca_rnaseq.tumour, file = "C:\\Users\\celia\\Documents\\IngenieriaBioinformatica\\HerramientasAlgoritmoBioinformatica\\herramientas_aurelio\\modules\\brca_rnaseq.RData")
